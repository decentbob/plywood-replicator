...
O=experiments/out
M="--steps 1500000 --every 20000 --maxBirthLog 200000 --W 40 --H 40 --nA 256 --nB 256 --nE 26 --pReload 0.005 --change 500000:pReload=0.0003 --pUnzip 1 --pUndock 0.1 --pFray 0.00003 --seedSeq ABBABA --seedCount 2 --pSoft 0.002 --pCapture 0.002 --pSpont 0.0002"
{
for sd in 1 2; do
