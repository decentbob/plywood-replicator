#!/bin/sh
# Telomeres, round 2: can a two-gene genome be assembled? (RESULTS.md, section 33.) Same world as telo.sh, endLoss on,
...
mkdir -p $O
C="--steps $STEPS --every 20000 --maxBirthLog 600000 --W 40 --H 40 --nA 200 --nB 200 --nC 200 --nD 200 --nP 120 --nQ 120 --capFray 0.03 --pUnzip 1 --pUndock 0 --pFray 0.001 --seedCount 3 --pSoft 0.002 --pCapture 0.002 --feed 1 --shield 1 --relay 1 --endLoss 1 --seedSeq PABAQ,PCDCQ --nE 16 --pReload 0.0004 --pBreak 0.00003"
{
for sd in 1 2; do
