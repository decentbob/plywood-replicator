...
for b in 0.0001 0.0003; do echo "ST_radback_b${b}_$sd --seed $sd --steps 60000 $A --backCopy 1 --pBreak $b"; done
for b in 0 0.0001 0.0003; do echo "ST_slipA_b${b}_$sd --seed $sd --steps 100000 $A $S --pSNuc 0 --pSBind 0.1 --pBreak $b --smeltA 20"; echo "ST_slipctl_b${b}_$sd --seed $sd --steps 100000 $A $S --pSNuc 0 --pSBind 0.1 --pBreak $b"; done
