...
// Usage: node experiments/world.js <index> [--steps=2000000] [--every=100000] [--births=FILE] [k=v,k=v overrides]
const { Sim } = require('../src/sim.js');
const { draw } = require('./search.js');
const fs = require('fs');
...
const p = Object.assign(draw(i), over, { maxBirthLog: 1000000 });
const s = new Sim(p);
