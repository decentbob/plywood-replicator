...
for seed in 21 22; do
  echo "C_unit_E300_fray0_$seed    --seed $seed --nE 300 --energyMode unit   --pFray 0"
  echo "C_strand_E300_fray0_$seed  --seed $seed --nE 300 --energyMode strand --pFray 0"
  echo "C_unit_E10_fray0_$seed     --seed $seed --nE 10 --pReload 0.0005 --energyMode unit   --pFray 0"
  echo "C_strand_E10_fray0_$seed   --seed $seed --nE 10 --pReload 0.0005 --energyMode strand --pFray 0"
  echo "C_unit_E300_fray3_$seed    --seed $seed --nE 300 --energyMode unit   --pFray 0.0003"
  echo "C_strand_E10_fray3_$seed   --seed $seed --nE 10 --pReload 0.0005 --energyMode strand --pFray 0.0003"
done
