...
| `bendA` | 15c (lead), 40f (negative), 49a (works), 49b (lead), 49c (lead), 50a (works), 50b (works), 50c (lead) |
| `bendB` | 15c (lead), 15d (works), 48 (negative), 49a (works), 49b (lead), 49c (lead), 50a (works), 50b (works), 50c (lead) |
...
| `chiral` | 30 (partial) |
| `compCopy` | 29 (partial), 49a (works), 49b (lead), 49c (lead), 50c (lead) |
| `cut` | 26 (negative) |
...
| `pCut` | 26 (negative) |
| `pFray` | 1 (works), 2 (works), 4 (negative), 5b (negative), 12 (works), 13 (works), 13b (works), 33a (partial), 44d (lead), 49c (lead), 50c (lead) |
...
| `pocket` | 39b (works), 39c (works), 39d (inconclusive), 39e (inconclusive), 39f (partial), 41a (negative), 41b (works), 41c (inconclusive), 50a (works), 50b (works), 50c (lead) |
...
| `pUnzip` | 13b (works), 15b (works), 49c (lead) |
| `radBand` | 33g (lead) |
...
- **From fuel capture to repeated reproduction** (49–50): persistent curvature does acquire fuel, but isolated
  recovery stops at a subset of sites. Shared contacts let square and curved founders start copying. Curved
  descendants have no generation-2 births in the four-seed 100k no-turnover confirmation. Measure rearming of
  individual released offspring and material trapped in unfinished rows before density/turnover interventions.
  Keep solver controls; neither isolated capture nor initial startup establishes a shape-fitness advantage.
