...
**Phase 3, structure.** *Next.* First map the optimum length under R6 as a function of `pUndock` and `pFray` (seed 2-, 6-, 12- and 24-mers together). Then add sequence-dependent hinges (section 9), then a triangle type. Watch for self-closing rings. Ask: do ringed replicators outcompete open ones near the sun?
